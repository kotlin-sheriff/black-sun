...
class TelegramBot(private val bot: Bot) {
  ...
  ) = bot.getUpdates(offset, limit, timeout, allowedUpdates)


  suspend fun processUpdate(update: Update) = bot.processUpdate(update)


  suspend fun processUpdate(updateJson: String) = bot.processUpdate(updateJson)
   ...
   */
  fun getMe(): TelegramBotResult<User> = bot.getMe()
  ...
  ): TelegramBotResult<Message> = bot.sendMessage(
    chatId,
    text,
    parseMode,
  ...
  fun forwardMessage(
    ...
    messageId: Long,
    disableNotification: Boolean? = null,
  ): TelegramBotResult<Message> = bot.forwardMessage(
    chatId,
    fromChatId,
    messageId,
    disableNotification,
  ...
  fun sendGame(
    ...
    allowSendingWithoutReply: Boolean? = null,
    replyMarkup: ReplyMarkup? = null,
  ): TelegramBotResult<Message> = bot.sendGame(
    chatId,
    gameShortName,
    disableNotification,
    replyToMessageId,
  ...
  fun sendMediaGroup(
    ...
    replyToMessageId: Long? = null,
    allowSendingWithoutReply: Boolean? = null,
  ): TelegramBotResult<List<Message>> = bot.sendMediaGroup(
    chatId,
    mediaGroup,
    disableNotification,
    replyToMessageId,
  ...
  fun sendPoll(
    ...
    allowSendingWithoutReply: Boolean? = null,
    replyMarkup: ReplyMarkup? = null,
  ): TelegramBotResult<Message> = bot.sendPoll(
    chatId,
    question,
    options,
    isAnonymous,
  ...
  fun getUserProfilePhotos(userId: Long, offset: Long? = null, limit: Int? = null) =
    bot.getUserProfilePhotos(userId, offset, limit)

  fun getFile(fileId: String) = bot.getFile(fileId)

  fun downloadFile(filePath: String) = bot.downloadFile(filePath)

  fun downloadFileBytes(fileId: String) = bot.downloadFileBytes(fileId)
  ...
  ): Pair<retrofit2.Response<Response<Boolean>?>?, Exception?> {
    requireNotNull(untilDate)
    val finishSecond = now().epochSecond + untilDate
    val finishInstant = ofEpochSecond(finishSecond)
    val durationTotal = Duration.between(now(), finishInstant)
    require(durationTotal.toSeconds() > 31) {
      "See 'until_date' param at https://core.telegram.org/bots/api#restrictchatmember"
    }
    require(durationTotal.toHours() <= 72) {
      "No one can be banned for more than 72 hours"
    }
  ...
  ): TelegramBotResult<Boolean> = bot.promoteChatMember(
    chatId,
    userId,
    isAnonymous,
    canChangeInfo,
  ...
  fun exportChatInviteLink(chatId: ChatId) = bot.exportChatInviteLink(chatId)
  ...
  fun deleteChatPhoto(chatId: ChatId) = bot.deleteChatPhoto(chatId)

  fun setChatTitle(chatId: ChatId, title: String) = bot.setChatTitle(chatId, title)
  ...
  fun pinChatMessage(
    ...
    messageId: Long,
    disableNotification: Boolean? = null,
  ): TelegramBotResult<Boolean> = bot.pinChatMessage(chatId, messageId, disableNotification)
  ...
  fun unpinChatMessage(
    chatId: ChatId,
    messageId: Long? = null,
  ): TelegramBotResult<Boolean> = bot.unpinChatMessage(chatId, messageId)
  ...
  fun unpinAllChatMessages(
    chatId: ChatId,
  ): TelegramBotResult<Boolean> = bot.unpinAllChatMessages(chatId)
   ...
   * @return True on success.
   */
  fun leaveChat(chatId: ChatId): TelegramBotResult<Boolean> = bot.leaveChat(chatId)
   ...
   */
  fun getChat(chatId: ChatId): TelegramBotResult<Chat> = bot.getChat(chatId)
  ...
  fun getChatAdministrators(
    chatId: ChatId,
  ): TelegramBotResult<List<ChatMember>> = bot.getChatAdministrators(chatId)

  fun getChatMemberCount(chatId: ChatId) = bot.getChatMemberCount(chatId)
  ...
  fun getChatMember(
    chatId: ChatId,
    userId: Long,
  ): TelegramBotResult<ChatMember> = bot.getChatMember(
    chatId,
    userId,
  )
  ...
  ): TelegramBotResult<Boolean> = bot.setChatStickerSet(
    chatId,
    stickerSetName,
  )
  ...
  fun deleteChatStickerSet(
    chatId: ChatId,
  ): TelegramBotResult<Boolean> = bot.deleteChatStickerSet(chatId)
  ...
  fun answerCallbackQuery(
    ...
    url: String? = null,
    cacheTime: Int? = null,
  ): TelegramBotResult<Boolean> = bot.answerCallbackQuery(
    callbackQueryId,
    text,
    showAlert,
    url,
  ...
  ): TelegramBotResult<Poll> = bot.stopPoll(
    chatId,
    messageId,
    replyMarkup,
  )
  ...
  fun deleteMessage(
    chatId: ChatId,
    messageId: Long,
  ): TelegramBotResult<Boolean> = bot.deleteMessage(
    chatId,
    messageId,
  )
  ...
  fun sendInvoice(
    ...
    allowSendingWithoutReply: Boolean? = null,
    replyMarkup: InlineKeyboardMarkup? = null,
  ): TelegramBotResult<Message> = bot.sendInvoice(
    chatId,
    paymentInvoiceInfo,
    disableNotification,
    replyToMessageId,
  ...
  ): TelegramBotResult<Boolean> = bot.answerShippingQuery(
    shippingQueryId,
    ok,
    shippingOptions,
    errorMessage,
  ...
  fun answerPreCheckoutQuery(
    ...
    ok: Boolean,
    errorMessage: String? = null,
  ): TelegramBotResult<Boolean> = bot.answerPreCheckoutQuery(
    preCheckoutQueryId,
    ok,
    errorMessage,
  )
  ...
  fun answerInlineQuery(
    ...
    switchPmText: String? = null,
    switchPmParameter: String? = null,
  ): TelegramBotResult<Boolean> = bot.answerInlineQuery(
    inlineQueryId,
    inlineQueryResults,
    cacheTime,
    isPersonal,
   ...
   */
  fun getMyCommands(): TelegramBotResult<List<BotCommand>> = bot.getMyCommands()
  ...
  ): TelegramBotResult<Boolean> = bot.setMyCommands(commands)
  ...
  fun sendDice(
    ...
    allowSendingWithoutReply: Boolean? = null,
    replyMarkup: ReplyMarkup? = null,
  ): TelegramBotResult<Message> = bot.sendDice(
    chatId,
    emoji,
    disableNotification,
    replyToMessageId,
  ...
  fun setChatAdministratorCustomTitle(
    ...
    userId: Long,
    customTitle: String,
  ): TelegramBotResult<Boolean> = bot.setChatAdministratorCustomTitle(
    chatId,
    userId,
    customTitle,
  )
